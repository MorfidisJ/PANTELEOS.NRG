...
const TEAM_DATA = {
  "DR. ALEXANDROS PANTELEOS": {
    ...
    email: "a.panteleos@panteleos-nrg.gr",
  ...
  "DIMITRIS VAMVAKAS": {
    ...
    email: "d.vamvakas@panteleos-nrg.gr",
  ...
  "ELENI STAVROU": {
    ...
    email: "e.stavrou@panteleos-nrg.gr",
  ...
  "NIKOS KAZANTZIS": {
    ...
    email: "n.kazantzis@panteleos-nrg.gr",
  ...
  "MARIA PAPADOPOULOU": {
    ...
    email: "m.papadopoulou@panteleos-nrg.gr",
  ...
  "GIORGOS MAKRIS": {
    ...
    email: "g.makris@panteleos-nrg.gr",
